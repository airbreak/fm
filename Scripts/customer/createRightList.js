...
function createMHzList(userId) {
 ...
 //得到系统推荐的mhz和品牌Mhz
    ...
    /*FM客户端*/
    function createFMCustomer() { 
       var  str_fmCustomer="<div>豆瓣FM客户端</div>"+
                                            "<div class='allOpertion'>" +
                                                "<a title='苹果手机系统' id='iosOperation' href='javascript:void'></a>" +
                                                "<a title='安卓手机系统' id='andriodOperation' href='javascript:void'></a>" +
                                                "<a title='微软手机系统'  id='wpOperation' href='javascript:void'></a>" +
                                            "</div>";
       $(".fmCustomer").append(str_fmCustomer);
